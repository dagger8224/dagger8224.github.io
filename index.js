export const onLoad = language_packages => {
...
export const onLoaded = ($router, demo) => require(['vs/editor/editor.main'], () => {
    const resultElement = document.querySelector('#result');
    resultElement && resultElement.scrollTo(0, 0);
    window.$editor && window.$editor.setScrollPosition({scrollTop: 0});
    monaco.editor.setModelLanguage(window.$editor.getModel(), ($router.schemes.type && 'json') || 'html');
    window.$editor.setValue(demo);
});
